 ...
 *      Input: [[1,2],[3,4]]
 *      Output: 17
 *      Explanation: Here are the three projections ("shadows") of the 
...
{
    public class Problem_883
    {
        public class Solution
        {
            public int ProjectionArea(int[][] grid)
            {
                int projectionArea = 0;
